...
Loon/Surge
[Script]
http-response ^https?://api\.m\.jd\.com/(client\.action|api)\?functionId=(wareBusiness|serverConfig|basicConfig|lite_wareBusiness|pingou_item) requires-body=1,script-path=hhttps://raw.githubusercontent.com/ybaojin/fun/main/Script/jd_price.js, tag=京东比价
[MITM]
hostname = api.m.jd.com

QX:
^https?://api\.m\.jd\.com/(client\.action|api)\?functionId=(wareBusiness|serverConfig|basicConfig|lite_wareBusiness|pingou_item) url script-response-body hhttps://raw.githubusercontent.com/ybaojin/fun/main/Script/jd_price.js
        ...
        if (!cookie) {
            ...
            let options = {
                ...
                headers: {
                    ...
                    "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 13_7 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 MicroMessenger/8.0.4(0x18000429) NetType/WIFI Language/zh_CN",
